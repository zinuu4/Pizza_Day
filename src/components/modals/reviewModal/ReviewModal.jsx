...
const ReviewModal = () => {
  ...
  const { setScroll, handleWrapperClick, handleWrapperClickDispatch } =
    useModalToggle();
  ...
  const MemoizedReviewModal = React.memo(() => (
    <div
      ...
      onClick={(e) => handleWrapperClickDispatch(e, setReviewModal)}
    >
      <div className="modal reviewModal animate__animated animate__fadeInUp custom-animation">
        <div className="reviewModal__top">
          ...
          <button
            ...
            className="btn-close"
          >
            <img className="icon-close" src={close} alt="Close review modal" />
          </button>
        </div>

        <div className="reviewModal__content">
          <div className="reviewModal__address">
            Pizza Day near Most-City, Lamana street, 2A
          </div>
          ...
          <Formik
            ...
            validationSchema={Yup.object({
              ...
              rulesAgreement: Yup.boolean().oneOf([true], "Consent required"),
            })}
            onSubmit={handleSubmit}
          >
            {({ isValid, dirty }) => (
              <Form className="reviewModal__form">
                <label className="reviewModal__input-label" htmlFor="name">
                  Your name*
                </label>
                <Field
                  id="name"
                ...
                <label className="reviewModal__input-label" htmlFor="email">
                  Your email*
                </label>
                <Field
                  id="email"
                ...
                <div className="reviewModal__checkbox-wrapper">
                  ...
                  <div>
                    ...
                    <a href="https://www.eatery.club/privacy_policy.pdf">
                ...
                <button
                  ...
                  style={{
                    backgroundColor:
                      !isValid || !dirty ? "var(--input)" : "var(--accent)",
                    color:
                      !isValid || !dirty
                        ? "var(--disabled)"
                        : "var(--accentContent)",
  ...
  const MemoizedGratitudeModal = React.memo(() => (
    ...
    >
      <div
        style={{ display: gratitudeModal ? "flex" : "none" }}
        className="modal gratitudeModal"
      >
        <img
          onClick={() => setGratitudeModal(false)}
          className="gratitudeModal__close"
          src={close}
          alt="close modal"
        />
