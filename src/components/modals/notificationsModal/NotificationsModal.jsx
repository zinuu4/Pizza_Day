    ...
    <>
      {notificationsModal && (
        <div
          ...
          onClick={(e) => handleWrapperClickDispatch(e, setNotificationsModal)}
        >
          <div className="rightSideModal notifications__modal animate__animated animate__fadeInRight custom-animation">
            <div className="notifications__modal__top">
              <div className="notifications__modal__title">
                Personal notifications
              </div>
              <button
                onClick={() => dispatch(setNotificationsModal(false))}
                className="btn-close"
              >
                <img
                  className="icon-close"
                  src={close}
                  alt="close notifications modal"
                />
              </button>
            </div>
            <div className="notifications__modal__content-empty">
              <img src={mail} alt="no notifications" />
              <div className="notifications__modal__subtitle">
                You have no notifications
              </div>
              <div className="notifications__modal__text">
                Our admin is already printing a sensation, why not mark it with
                an order in our institution?
              </div>
            </div>
          </div>
        </div>
