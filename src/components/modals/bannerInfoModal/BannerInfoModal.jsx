        ...
        >
          <div className="modal modal__restaraunt-info animate__animated animate__fadeInUp custom-animation">
            <div className="modal__restaraunt-info-top">
              <h4 className="modal__restaraunt-info-title">
                Information about the restaurant
              </h4>
              <button
                className="btn-close"
                onClick={() => dispatch(setBannerInfoModal(false))}
              >
            ...
            <div className="modal__restaraunt-info-info">
              <div>
                <p className="modal__restaraunt-info-info-subtitle">
                  Business hours
                </p>
                ...
                <a
                  className="modal__restaraunt-info-info-phone"
                  href="tel:+380730836710"
                >
                  +380 (73) 083 67 10
                </a>
              </div>
