...
const Profile = () => {
  ...
  const { city, avatar, email, name, surname, gender, birthday } = useSelector(
    (state) => state.user
  );
          ...
          <Form>
            <div className="profile__fields-wrapper">
              <label className="profile__input-wrapper" htmlFor="name">
                ...
                <Field id="name" name="name" className="profile__input" />
                <ErrorMessage
              ...
              <label className="profile__input-wrapper" htmlFor="surname">
                ...
                <Field id="surname" name="surname" className="profile__input" />
                <ErrorMessage
                  className="profile__input__error"
                  name="surname"
                  component="div"
            ...
            <button
              ...
              style={{
                backgroundColor:
                  !isValid || isSubmitting ? "var(--input)" : "var(--accent)",
                color:
                  !isValid || isSubmitting
                    ? "var(--disabled)"
                    : "var(--accentContent)",
