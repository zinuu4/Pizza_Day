    ...
    >
      ...
      >
        ...
        <div className='modal__top'>
          <h4 className='modal__title'>Information about the restaurant</h4>
          <img 
            onClick={() => dispatch(setRestarauntModal(false))}  className='modal__close' 
            src={close} 
            alt="close" 
          />
        </div>
        ...
        <div className='modal__info'>
          ...
          <div>
            <p className='modal__info-subtitle'>Business hours</p>
            <div className='modal__info-time'>
              <span className='modal__info-circle'></span>
              Opened from 10:00 to 22:00
            </div>
            <a className="modal__info-phone" href="tel:+380730836710">+380 (73) 083 67 10</a>
          </div>

          <div>
            <p className='modal__info-subtitle'>Address</p>
