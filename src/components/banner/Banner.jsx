          ...
          <div className="banner__wrapper">
            <ul className="banner__delivery-type">
              <li className="banner__delivery-type-text">
                <img
                  className="banner__delivery-type-icon"
                  src={shoppingBasket}
                  alt="delivery type"
                />
                Take-out
            ...
            <div className="banner__info">
              ...
              <a className="banner__info-phone" href="tel:+380730836710">
                +380 (73) 083 66 91
              </a>

              <button
                onClick={handleInfoButtonClick}
                className="banner__info-about"
              >
                <div className="banner__info-about-text-wrapper">
                  <p className="banner__info-about-text">
              ...
              <div onClick={handleReviewClick} className="banner__review">
                <p className="banner__review-text">
                  Leave a review about the work of the institution or your
                  recent delivery.
                </p>
