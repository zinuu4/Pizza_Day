...
const AppHeader = () => {
  ...
  const booleanDeliveryAddress = useMemo(
        ...
        <>
          <div className="header__profile__wrapper">
            <div className="header__profile__loyalty-wrapper">
              ...
              <div className="header__profile__loyalty-text">
                Loyalty Program
                <div className="loyalty__info">
                  <div className="loyalty__info__title">Як це працює?</div>
                  <div className="loyalty__info__text">
                    📈 Бонуси нараховуються в розмірі 1% від кожної покупки
                    зареєстрованого клієнта.
                    <br />
                    <br />
        ...
        <div className="container">
          <div className="header__wrapper">
            ...
            {booleanDeliveryAddress && (
              <div
                onClick={() => dispatch(setDeliveryModal(true))}
                className="location"
              >
                <img
