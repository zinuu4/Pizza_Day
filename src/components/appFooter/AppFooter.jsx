    ...
    <footer className="footer">
      <div className="container">
          ...
          <div className="left-block__wrapper">
            <div className="pizza">
              ...
              <nav className="pizza__nav">
                <a className="pizza__nav-link" href="google.com">
                  Work
                </a>
                <a className="pizza__nav-link" href="google.com">
                  Suppliers
                </a>
                <a className="pizza__nav-link" href="tel:+380961781818">
                  Hotline +380 (96) 178 18 18
                </a>
                <a className="pizza__nav-link" href="google.com">
                  manager@pizzaday.com.ua
                </a>
              </nav>
            </div>
            ...
            <div className="pickup">
              ...
              <div className="pickup__info-wrapper">
                ...
                <a href="tel:+380730836710" className="pickup__phone">
                  +380 (73) 083 67 10
                </a>
              </div>
              <div className="pickup__payments">
                <img
                  className="pickup__payments-mastercard"
                  src={masterCard}
                  alt="MasterCard"
                />
        ...
        <div className="privacy">
          <p className="privacy__copyright">© 2023 Pizza Day</p>
          <a
